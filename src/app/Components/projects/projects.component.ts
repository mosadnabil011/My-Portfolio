...
export class ProjectsComponent {
  ...
  {
    title: 'BMW Website',
    description: 'Designed and developed a static, non-responsive website for BMW, showcasing information about BMW models, electric cars, and lifestyle. Utilized HTML5 and CSS3 to create a structured layout with a fixed header, navigation menu, and interactive elements. Implemented sections for Home, Models, Electric, BMW Lifestyle, and Contact with a modern design.',
